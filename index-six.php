...
<body>
    <!-- HEADER AREA -->
        <?php include 'layout/header/header-four.php';?>
    <!-- HEADER AREA END -->
            ...
            <div class="banner-slider-active">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="rts-hero-banner banner-six" style="background-image: url(assets/images/banner/banner__six.png);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 offset-md-2 col-xl-6 offset-xxl-0 col-md-10">
                                        <div class="banner-content">
                                            <div class="banner-top">
                                                <div class="icon"><img src="assets/images/banner/title-shape.svg" alt=""></div>
                                                Meet Hostie
                                            </div>
                                            <h1 class="banner-title">
                                                A smarter way
                                                to <span>WordPress</span>
                                            </h1>
                                            <p class="description">
                                                Rest easy knowing that our team of experts is dedicated
                                                to delivering top-notch performance
                                            </p>
                                            <div class="banner-btn">
                                                <a href="pricing.php" class="rts-btn btn__long white__bg secondary__color">Plan & Pricing <i class="fa-regular fa-chevron-right"></i></a>
                                                <a href="contact.php" class="rts-btn btn__long border__white white__color">Get a Quote <i class="fa-regular fa-chevron-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rts-hero-banner banner-six" style="background-image: url(assets/images/banner/banner__six-2.png);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 offset-md-2 col-xl-6 offset-xxl-0 col-md-10">
                                        <div class="banner-content">
                    ...
                    <div class="swiper-slide">
                        <div class="rts-hero-banner banner-six" style="background-image: url(assets/images/banner/banner__six-3.png);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 offset-md-2 col-xl-6 offset-xxl-0 col-md-10">
                                        <div class="banner-content">
    ...
    <section class="rts-feature-six section__padding">
        <div class="container">
            ...
            <div class="row gy-30">
                ...
                <div class="col-lg-3 col-md-6" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                    <div class="single__feature">
                        <div class="single__feature--box">
                            <div class="single__feature--box-icon">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-3 col-md-6" data-sal="slide-down" data-sal-delay="700" data-sal-duration="800">
                    <div class="single__feature">
                        <div class="single__feature--box">
                            <div class="single__feature--box-icon">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="plan__btn">
                    <a href="pricing.php">See Our Hosting Plan <i class="fa-regular fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-490 text-center">
                    ...
                    <p class="rts-section__description" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Globally incubate next-generation e-services via state <br>
                        ...
                        <div class="rts-pricing-plan__tab plan__tab">
                            <div class="tab__button">
                                <div class="tab__button__item">
                                    <button class="active tab__price" data-tab="monthly">monthly</button>
            ...
            <div class="view-plan-btn">
                <a href="pricing-two.php" class="btn long-btn">view all plan</a>
            </div>
        </div>
    </div>
    ...
    <!-- HOSTIE SERVICE FAQ AREA -->
    <section class="rts-service-tab ghost__white section__padding sevice-tab-section-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-450 text-center">
                    ...
                    <p class="rts-section__description" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Your first website to Cloud ways from any web host for without breaking your live site hosted.
                    </p>
                </div>
            </div>
            <!-- service area -->
            <div class="row g-40">
                <div class="col-lg-5 col-md-4" data-sal="slide-right" data-sal-delay="400" data-sal-duration="800">
                    <div class="rts-service-four__tab">
                            ...
                            <div class="tab__icon">
                                <svg width="45" height="45" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_341_3634)">
                                        ...
                                        <path d="M45.1904 24.498C45.1904 22.7177 43.7421 21.2695 41.9619 21.2695C40.1817 21.2695 38.7334 22.7178 38.7334 24.498C38.7334 26.2782 40.1817 27.7265 41.9619 27.7265C43.7421 27.7265 45.1904 26.2783 45.1904 24.498ZM40.1689 24.498C40.1689 23.5094 40.9732 22.7051 41.9619 22.7051C42.9506 22.7051 43.7548 23.5094 43.7548 24.498C43.7548 25.4867 42.9506 26.291 41.9619 26.291C40.9732 26.291 40.1689 25.4867 40.1689 24.498Z" fill="#2D3C58"></path>
                                        <path d="M45.1904 39.3145C45.1904 37.5342 43.7421 36.0859 41.9619 36.0859C40.1817 36.0859 38.7334 37.5343 38.7334 39.3145C38.7334 41.0947 40.1817 42.5429 41.9619 42.5429C43.7421 42.543 45.1904 41.0948 45.1904 39.3145ZM40.1689 39.3145C40.1689 38.3258 40.9732 37.5215 41.9619 37.5215C42.9506 37.5215 43.7548 38.3258 43.7548 39.3145C43.7548 40.3031 42.9506 41.1074 41.9619 41.1074C40.9732 41.1075 40.1689 40.3031 40.1689 39.3145Z" fill="#2D3C58"></path>
                                    </g>
                                    <defs>
                        ...
                        <div class="single__tab tab__btn" data-tab="dedicated">
                            <div class="tab__icon">
                                <svg width="45" height="45" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.5749 4.8999C6.54875 4.8999 4.8999 6.54875 4.8999 8.5749C4.8999 10.6011 6.54875 12.2499 8.5749 12.2499C10.6011 12.2499 12.2499 10.6011 12.2499 8.5749C12.2499 6.54875 10.6011 4.8999 8.5749 4.8999ZM8.5749 10.6166C7.44954 10.6166 6.53324 9.70109 6.53324 8.5749C6.53324 7.44872 7.44954 6.53324 8.5749 6.53324C9.70027 6.53324 10.6166 7.44872 10.6166 8.5749C10.6166 9.70109 9.70027 10.6166 8.5749 10.6166Z" fill="#2D3C58"></path>
                                    <path d="M40.8333 8.16678C41.2843 8.16678 41.6499 7.80115 41.6499 7.35011C41.6499 6.89908 41.2843 6.53345 40.8333 6.53345C40.3822 6.53345 40.0166 6.89908 40.0166 7.35011C40.0166 7.80115 40.3822 8.16678 40.8333 8.16678Z" fill="#2D3C58"></path>
                                    <path d="M37.5667 8.16678C38.0177 8.16678 38.3833 7.80115 38.3833 7.35011C38.3833 6.89908 38.0177 6.53345 37.5667 6.53345C37.1156 6.53345 36.75 6.89908 36.75 7.35011C36.75 7.80115 37.1156 8.16678 37.5667 8.16678Z" fill="#2D3C58"></path>
                                    <path d="M42.4666 10.6167C42.9176 10.6167 43.2832 10.2511 43.2832 9.80007C43.2832 9.34903 42.9176 8.9834 42.4666 8.9834C42.0155 8.9834 41.6499 9.34903 41.6499 9.80007C41.6499 10.2511 42.0155 10.6167 42.4666 10.6167Z" fill="#2D3C58"></path>
                                    <path d="M39.2 10.6167C39.651 10.6167 40.0166 10.2511 40.0166 9.80007C40.0166 9.34903 39.651 8.9834 39.2 8.9834C38.7489 8.9834 38.3833 9.34903 38.3833 9.80007C38.3833 10.2511 38.7489 10.6167 39.2 10.6167Z" fill="#2D3C58"></path>
                                    <path d="M34.3001 8.16678C34.7511 8.16678 35.1167 7.80115 35.1167 7.35011C35.1167 6.89908 34.7511 6.53345 34.3001 6.53345C33.849 6.53345 33.4834 6.89908 33.4834 7.35011C33.4834 7.80115 33.849 8.16678 34.3001 8.16678Z" fill="#2D3C58"></path>
                                    <path d="M35.9334 10.6167C36.3844 10.6167 36.75 10.2511 36.75 9.80007C36.75 9.34903 36.3844 8.9834 35.9334 8.9834C35.4823 8.9834 35.1167 9.34903 35.1167 9.80007C35.1167 10.2511 35.4823 10.6167 35.9334 10.6167Z" fill="#2D3C58"></path>
                                    <path d="M31.0335 8.16678C31.4845 8.16678 31.8501 7.80115 31.8501 7.35011C31.8501 6.89908 31.4845 6.53345 31.0335 6.53345C30.5824 6.53345 30.2168 6.89908 30.2168 7.35011C30.2168 7.80115 30.5824 8.16678 31.0335 8.16678Z" fill="#2D3C58"></path>
                                    <path d="M32.6668 10.6167C33.1178 10.6167 33.4834 10.2511 33.4834 9.80007C33.4834 9.34903 33.1178 8.9834 32.6668 8.9834C32.2157 8.9834 31.8501 9.34903 31.8501 9.80007C31.8501 10.2511 32.2157 10.6167 32.6668 10.6167Z" fill="#2D3C58"></path>
                                    <path d="M27.7669 8.16678C28.2179 8.16678 28.5835 7.80115 28.5835 7.35011C28.5835 6.89908 28.2179 6.53345 27.7669 6.53345C27.3158 6.53345 26.9502 6.89908 26.9502 7.35011C26.9502 7.80115 27.3158 8.16678 27.7669 8.16678Z" fill="#2D3C58"></path>
                                    <path d="M29.4002 10.6167C29.8512 10.6167 30.2168 10.2511 30.2168 9.80007C30.2168 9.34903 29.8512 8.9834 29.4002 8.9834C28.9491 8.9834 28.5835 9.34903 28.5835 9.80007C28.5835 10.2511 28.9491 10.6167 29.4002 10.6167Z" fill="#2D3C58"></path>
                                    <path d="M49 13.3868V3.7632C49 1.68805 47.3119 0 45.2368 0H3.7632C1.68805 0 0 1.68805 0 3.7632V13.386C0 14.5857 0.574117 15.6432 1.45122 16.3325C0.574117 17.0226 0 18.081 0 19.2799V28.9026C0 30.1023 0.574117 31.1599 1.45122 31.8492C0.574117 32.5393 0 33.5977 0 34.7965V44.4193C0 46.4953 1.68805 48.1833 3.7632 48.1833H45.236C47.3111 48.1833 48.9992 46.4953 48.9992 44.4201V34.7965C48.9992 33.5968 48.4251 32.5393 47.548 31.85C48.4259 31.1607 49 30.1023 49 28.9035V19.2799C49 18.0802 48.4259 17.0226 47.5488 16.3333C48.4259 15.6441 49 14.5857 49 13.3868ZM47.3667 34.7965V44.4193C47.3667 45.5937 46.4112 46.5492 45.2368 46.5492H3.7632C2.58883 46.55 1.63333 45.5945 1.63333 44.4201V34.7965C1.63333 33.6222 2.58883 32.6667 3.7632 32.6667H45.236C46.4112 32.6667 47.3667 33.6222 47.3667 34.7965ZM47.3667 19.2799V28.9026C47.3667 30.077 46.4112 31.0325 45.2368 31.0325H3.7632C2.58883 31.0333 1.63333 30.0778 1.63333 28.9035V19.2799C1.63333 18.1055 2.58883 17.15 3.7632 17.15H45.236C46.4112 17.15 47.3667 18.1055 47.3667 19.2799ZM3.7632 15.5167C2.58883 15.5167 1.63333 14.5612 1.63333 13.3868V3.7632C1.63333 2.58883 2.58883 1.63333 3.7632 1.63333H45.236C46.4112 1.63333 47.3667 2.58883 47.3667 3.7632V13.386C47.3667 14.5603 46.4112 15.5158 45.2368 15.5158L3.7632 15.5167Z" fill="#2D3C58"></path>
                                    <path d="M8.5749 27.7667C10.6011 27.7667 12.2499 26.1179 12.2499 24.0917C12.2499 22.0656 10.6011 20.4167 8.5749 20.4167C6.54875 20.4167 4.8999 22.0656 4.8999 24.0917C4.8999 26.1179 6.54875 27.7667 8.5749 27.7667ZM8.5749 22.0501C9.70027 22.0501 10.6166 22.9656 10.6166 24.0917C10.6166 25.2179 9.70027 26.1334 8.5749 26.1334C7.44954 26.1334 6.53324 25.2179 6.53324 24.0917C6.53324 22.9656 7.44954 22.0501 8.5749 22.0501Z" fill="#2D3C58"></path>
                                    <path d="M40.8333 23.6834C41.2843 23.6834 41.6499 23.3177 41.6499 22.8667C41.6499 22.4157 41.2843 22.05 40.8333 22.05C40.3822 22.05 40.0166 22.4157 40.0166 22.8667C40.0166 23.3177 40.3822 23.6834 40.8333 23.6834Z" fill="#2D3C58"></path>
                                    <path d="M37.5667 23.6834C38.0177 23.6834 38.3833 23.3177 38.3833 22.8667C38.3833 22.4157 38.0177 22.05 37.5667 22.05C37.1156 22.05 36.75 22.4157 36.75 22.8667C36.75 23.3177 37.1156 23.6834 37.5667 23.6834Z" fill="#2D3C58"></path>
                                    <path d="M42.4666 26.1333C42.9176 26.1333 43.2832 25.7677 43.2832 25.3167C43.2832 24.8656 42.9176 24.5 42.4666 24.5C42.0155 24.5 41.6499 24.8656 41.6499 25.3167C41.6499 25.7677 42.0155 26.1333 42.4666 26.1333Z" fill="#2D3C58"></path>
                                    <path d="M39.2 26.1333C39.651 26.1333 40.0166 25.7677 40.0166 25.3167C40.0166 24.8656 39.651 24.5 39.2 24.5C38.7489 24.5 38.3833 24.8656 38.3833 25.3167C38.3833 25.7677 38.7489 26.1333 39.2 26.1333Z" fill="#2D3C58"></path>
                                    <path d="M34.3001 23.6834C34.7511 23.6834 35.1167 23.3177 35.1167 22.8667C35.1167 22.4157 34.7511 22.05 34.3001 22.05C33.849 22.05 33.4834 22.4157 33.4834 22.8667C33.4834 23.3177 33.849 23.6834 34.3001 23.6834Z" fill="#2D3C58"></path>
                                    <path d="M35.9334 26.1333C36.3844 26.1333 36.75 25.7677 36.75 25.3167C36.75 24.8656 36.3844 24.5 35.9334 24.5C35.4823 24.5 35.1167 24.8656 35.1167 25.3167C35.1167 25.7677 35.4823 26.1333 35.9334 26.1333Z" fill="#2D3C58"></path>
                                    <path d="M31.0335 23.6834C31.4845 23.6834 31.8501 23.3177 31.8501 22.8667C31.8501 22.4157 31.4845 22.05 31.0335 22.05C30.5824 22.05 30.2168 22.4157 30.2168 22.8667C30.2168 23.3177 30.5824 23.6834 31.0335 23.6834Z" fill="#2D3C58"></path>
                                    <path d="M32.6668 26.1333C33.1178 26.1333 33.4834 25.7677 33.4834 25.3167C33.4834 24.8656 33.1178 24.5 32.6668 24.5C32.2157 24.5 31.8501 24.8656 31.8501 25.3167C31.8501 25.7677 32.2157 26.1333 32.6668 26.1333Z" fill="#2D3C58"></path>
                                    <path d="M27.7669 23.6834C28.2179 23.6834 28.5835 23.3177 28.5835 22.8667C28.5835 22.4157 28.2179 22.05 27.7669 22.05C27.3158 22.05 26.9502 22.4157 26.9502 22.8667C26.9502 23.3177 27.3158 23.6834 27.7669 23.6834Z" fill="#2D3C58"></path>
                                    <path d="M29.4002 26.1333C29.8512 26.1333 30.2168 25.7677 30.2168 25.3167C30.2168 24.8656 29.8512 24.5 29.4002 24.5C28.9491 24.5 28.5835 24.8656 28.5835 25.3167C28.5835 25.7677 28.9491 26.1333 29.4002 26.1333Z" fill="#2D3C58"></path>
                                    ...
                                    <path d="M40.8333 39.2C41.2843 39.2 41.6499 38.8343 41.6499 38.3833C41.6499 37.9323 41.2843 37.5667 40.8333 37.5667C40.3822 37.5667 40.0166 37.9323 40.0166 38.3833C40.0166 38.8343 40.3822 39.2 40.8333 39.2Z" fill="#2D3C58"></path>
                                    <path d="M37.5667 39.2C38.0177 39.2 38.3833 38.8343 38.3833 38.3833C38.3833 37.9323 38.0177 37.5667 37.5667 37.5667C37.1156 37.5667 36.75 37.9323 36.75 38.3833C36.75 38.8343 37.1156 39.2 37.5667 39.2Z" fill="#2D3C58"></path>
                                    <path d="M42.4666 41.6499C42.9176 41.6499 43.2832 41.2843 43.2832 40.8333C43.2832 40.3822 42.9176 40.0166 42.4666 40.0166C42.0155 40.0166 41.6499 40.3822 41.6499 40.8333C41.6499 41.2843 42.0155 41.6499 42.4666 41.6499Z" fill="#2D3C58"></path>
                                    <path d="M39.2 41.6499C39.651 41.6499 40.0166 41.2843 40.0166 40.8333C40.0166 40.3822 39.651 40.0166 39.2 40.0166C38.7489 40.0166 38.3833 40.3822 38.3833 40.8333C38.3833 41.2843 38.7489 41.6499 39.2 41.6499Z" fill="#2D3C58"></path>
                                    <path d="M34.3001 39.2C34.7511 39.2 35.1167 38.8343 35.1167 38.3833C35.1167 37.9323 34.7511 37.5667 34.3001 37.5667C33.849 37.5667 33.4834 37.9323 33.4834 38.3833C33.4834 38.8343 33.849 39.2 34.3001 39.2Z" fill="#2D3C58"></path>
                                    <path d="M35.9334 41.6499C36.3844 41.6499 36.75 41.2843 36.75 40.8333C36.75 40.3822 36.3844 40.0166 35.9334 40.0166C35.4823 40.0166 35.1167 40.3822 35.1167 40.8333C35.1167 41.2843 35.4823 41.6499 35.9334 41.6499Z" fill="#2D3C58"></path>
                                    <path d="M31.0335 39.2C31.4845 39.2 31.8501 38.8343 31.8501 38.3833C31.8501 37.9323 31.4845 37.5667 31.0335 37.5667C30.5824 37.5667 30.2168 37.9323 30.2168 38.3833C30.2168 38.8343 30.5824 39.2 31.0335 39.2Z" fill="#2D3C58"></path>
                                    <path d="M32.6668 41.6499C33.1178 41.6499 33.4834 41.2843 33.4834 40.8333C33.4834 40.3822 33.1178 40.0166 32.6668 40.0166C32.2157 40.0166 31.8501 40.3822 31.8501 40.8333C31.8501 41.2843 32.2157 41.6499 32.6668 41.6499Z" fill="#2D3C58"></path>
                                    <path d="M27.7669 39.2C28.2179 39.2 28.5835 38.8343 28.5835 38.3833C28.5835 37.9323 28.2179 37.5667 27.7669 37.5667C27.3158 37.5667 26.9502 37.9323 26.9502 38.3833C26.9502 38.8343 27.3158 39.2 27.7669 39.2Z" fill="#2D3C58"></path>
                                    <path d="M29.4002 41.6499C29.8512 41.6499 30.2168 41.2843 30.2168 40.8333C30.2168 40.3822 29.8512 40.0166 29.4002 40.0166C28.9491 40.0166 28.5835 40.3822 28.5835 40.8333C28.5835 41.2843 28.9491 41.6499 29.4002 41.6499Z" fill="#2D3C58"></path>
                                </svg>
                            </div>
                ...
                <div class="col-lg-7 col-md-8">
                    <div class="rts-service-four__tab--content tab__content open" id="wp">
                        <div class="tab__image">
                            <img src="assets/images/service/service__tab.png" height="700" width="757" alt="live">
                        </div>
                        <div class="tab__content--details">
                            ...
                            <a href="faq.php" class="all-feature border__bottom">see all feature <i class="fa-regular fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="rts-service-four__tab--content tab__content" id="cloud">
                        <div class="tab__image">
                            <img src="assets/images/service/service__tab.png" width="757" height="500" alt="live">
                        </div>
                        <div class="tab__content--details">
                            ...
                            <a href="faq.php" class="all-feature">see all feature <i class="fa-regular fa-chevron-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="rts-service-four__tab--content tab__content" id="dedicated">
                        <div class="tab__image">
                            <img src="assets/images/service/service__tab-2.png" width="757" height="500" alt="live">
                        </div>
                        <div class="tab__content--details">
    ...
    <!-- HOSTIE SERVICE FAQ AREA END -->

    <!-- HOSTIE LATEST BLOG -->
    <section class="rts-blog-area blog-area-six pt--120 pb--120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="section-title-area w-450 text-center">
                    <h2 class="section-title " data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Latest Articles</h2>
                    <p class="desc" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">First website to Cloud ways from any web host your live site hosted on the old host.</p>
                </div>
            </div>
            <div class="section-inner">
                <div class="row gy-30">
                    <div class="col-lg-6" data-sal="slide-right" data-sal-delay="400" data-sal-duration="800">
                        <div class="blog-wrapper">
                            ...
                            <div class="content">
                                ...
                                <h3 class="blog-title animated fadeIn"><a href="blog-details.php">Expanding Horizons: Announcing the
                                        Availability of 13 New Data Center</a></h3>
                                <p class="desc">Cloudways is excited to announce the addition 16 new data centers Consisting...</p>

                                <a href="blog-details.php" class="read-more-btn">Read More <i class="fa-light fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6" data-sal="slide-left" data-sal-delay="500" data-sal-duration="800">
                        <div class="blog-wrapper">
                            <div class="image">
                            ...
                            <div class="content">
                                ...
                                <h3 class="blog-title animated fadeIn"><a href="blog-details.php">Introducing Edge Page Caching, Argo
                                        Smart Routing and More</a></h3>
                                <p class="desc">Cloudways is excited to announce the addition 16 new data centers Consisting...</p>
                                <a href="blog-details.php" class="read-more-btn">Read More <i class="fa-light fa-angle-right"></i></a>
                            </div>
                        </div>
    ...
    <!-- HOSTIE LATEST BLOG END -->

    <!-- HOSTIE CONTACT FORM -->
    <section class="rts-contact-form pt-120">
        <div class="container">
    ...
    <!-- HOSTIE CONTACT FORM END -->

    <!-- HOSTIE BRAND SLIDER -->
    <div class="rts-brand pt-100 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rts-brand__wrapper" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
    ...
    <!-- HOSTIE BRAND SLIDER END -->

    <!-- FOOTER AREA START-->
        <?php include 'layout/footer/footer-four.php';?>
    <!-- FOOTER AREA END -->
