            ...
            <div class="rts-header__wrapper">
                ...
                <div class="rts-header__logo">
                    <a href="index.php" class="site-logo">
                        <img class="logo__class" src="assets/images/logo/logo-11-top.svg" alt="Hostie">
                    </a>
                </div>
                <!-- FOR NAVIGATION MENU -->
                        ...
                        <ul class="list-unstyled hostie-desktop-menu">
                                ...
                                <div class="has-homemenu">
                                    <div class="row gx-5 row-cols-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-5">
                                        ...
                                        <div class="col homemenu">
                                            ...
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-two.php">Home 02</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            ...
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-three.php">Home 03</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            <div class="homemenu-thumb mb-15">
                                                <a href="index-four.php">
                                            ...
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-four.php">Home 04</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            <div class="homemenu-thumb mb-15">
                                                <a href="index-five.php">
                                                    <img src="assets/images/home/home-5.png" alt="">
                                                </a>
                                            </div>
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-five.php">Home 05</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            <div class="homemenu-thumb mb-15">
                                                <a href="index-six.php">
                                                    <img src="assets/images/home/home-6.png" alt="">
                                                </a>
                                            </div>
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-six.php">Home 06</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            <div class="homemenu-thumb mb-15">
                                                <a href="index-seven.php">
                                                    <img src="assets/images/home/home-8.png" alt="">
                                                </a>
                                            </div>
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-seven.php">Home 07</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            <div class="homemenu-thumb mb-15">
                                                <a href="index-eight.php">
                                                    <img src="assets/images/home/home-7.png" alt="">
                                                </a>
                                            </div>
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-eight.php">Home 08</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            <div class="homemenu-thumb mb-15">
                                                <a href="index-nine.php">
                                                    <img src="assets/images/home/home-9.png" alt="">
                                                </a>
                                            </div>
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-nine.php">Home 09</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            <div class="homemenu-thumb mb-15">
                                                <a href="index-ten.php">
                                                    <img src="assets/images/home/home-10.png" alt="">
                                                </a>
                                            </div>
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-ten.php">Home 10</a>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col homemenu">
                                            <div class="homemenu-thumb mb-15">
                                                <a href="index-eleven.php">
                                                    <img src="assets/images/home/home-11.png" alt="">
                                                </a>
                                            </div>
                                            <div class="homemenu-content text-center">
                                                <h4 class="homemenu-title">
                                                    <a href="index-eleven.php">Home 11</a>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="menu-item hostie-has-dropdown">
                                ...
                                <ul class="hostie-submenu list-unstyled menu-pages">
                                    <li class="nav-item"><a class="nav-link" href="domain-checker.php">Domain Checker</a></li>
                                    <li class="nav-item"><a class="nav-link" href="domain-transfer.php">Domain Transfer</a></li>
                                    <li class="nav-item"><a class="nav-link" href="domain-registration.php">Domain Resigtration</a></li>
                                    <li class="nav-item"><a class="nav-link" href="whois.php">Whois</a></li>
                                </ul>
                            </li>
                            <li class="menu-item hostie-has-dropdown">
                ...
                <div class="rts-header__right">
                    <div class="button-area d-flex gap-5 align-items-center">
                        <a href="#" class="login__btn d-flex gap-2 align-items-center"><i class="fa-regular fa-user"></i>Login</a>
                        <a href="#" class="get-started__btn">Get Started</a>
                    </div>
