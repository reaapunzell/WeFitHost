...
<body class="home-three">
    <!-- HEADER AREA -->
        <?php include 'layout/header/header-two.php';?>
    <!-- HEADER AREA END -->

    <!-- HERO BANNER ONE -->
    <section class="rts-hero-three">
        <div class="container">
    ...
    <!-- SERVICE AREA START -->
    <div class="rts-services-area area-3 pb-120" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
        <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-wrapper">
                            ...
                            <div class="content">
                                ...
                                <p class="desc">WordPress Hosting gives speed performance with full features.</p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section  text-center">
                    ...
                    <p class="rts-section__description w-420" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Globally incubate next-generation e-services via state of the art technology.
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="row justify-content-center" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                                    ...
                                    <div class="card-plan__feature">
                                        <ul class="card-plan__feature--list">
                                            <li class="card-plan__feature--list-item">
                                                ...
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Explore, discover, and learn on our innovative and informative website."><i class="fa-light fa-circle-question"></i></span>
                                            </li>
                                            <li class="card-plan__feature--list-item">
                                            ...
                                            <li class="card-plan__feature--list-item">
                                                ...
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Hostie provides reliable 24/7 support for your hosting needs, ensuring assistance whenever you require help."><i class="fa-light fa-circle-question"></i></span>
                                            </li>
                                            <li class="card-plan__feature--list-item">
                                                <span class="text"><i class="fa-regular fa-xmark"></i> Free Email</span>
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Hostie offers complimentary email services, empowering your online communication with reliable and secure free email solutions."><i class="fa-light fa-circle-question"></i></span>
                                            </li>
                                            <li class="card-plan__feature--list-item">
                                                <span class="text"><i class="fa-regular fa-xmark"></i> Unlimited Bandwidth</span>
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Hostie provides unlimited bandwidth, ensuring seamless data transfer for your website's optimal performance and user experience."><i class="fa-light fa-circle-question"></i></span>
                                            </li>
                                            <li class="card-plan__feature--list-item">
                                                <span class="text"><i class="fa-regular fa-xmark"></i> 100 GB SSD Storage</span>
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Elevate your online presence with Hostie, offering unlimited bandwidth for your domain, ensuring optimal performance and seamless data flow."><i class="fa-light fa-circle-question"></i></span>
                                            </li>


                                            <li class="card-plan__feature--list-item">
                                                <span class="text"><i class="fa-regular fa-check"></i> Unlimited Free SSL</span>
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Secure your website with Hostie's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                                            </li>
                                            <li class="card-plan__feature--list-item">
                                                <span class="text"><i class="fa-regular fa-check"></i> 99.9% Uptime Guarantee</span>
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Hostie guarantees 99% uptime, ensuring your website is consistently available and reliable for visitors around the clock."><i class="fa-light fa-circle-question"></i></span>
                                            </li>
                                            <li class="card-plan__feature--list-item">
                                                <span class="text"><i class="fa-regular fa-xmark"></i> Web Application Firewall</span>
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Enhance your website's security with Hostie's Web Application Firewall, protecting against online threats and ensuring a safe online environment."><i class="fa-light fa-circle-question"></i></span>
                                            </li>
                                        ...
                                        <ul class="card-plan__feature--list more__feature">
                                            <li class="card-plan__feature--list-item">
                                                ...
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Hostie offers generous hosting with 100GB SSD storage, providing ample space for your data and ensuring high-performance storage solutions."><i class="fa-light fa-circle-question"></i></span>
                                            </li>
                                            <li class="card-plan__feature--list-item">
                                                <span class="text"><i class="fa-regular fa-check"></i> Unlimited Free SSL</span>
                                                <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Secure your website with Hostie's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
    ...
    <!-- SERVICE AREA START -->
    <div class="rts-services-area area-3 service-bg pt--120 pb-120">
        <div class="container">
            <div class="section-title-area text-center">
                <h2 class="section-title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Our Best Services</h2>
                <p class="desc" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Your first website to Cloud ways from any web host for without breaking your live site hosted.</p>
            </div>
            <div class="section-inner">
                <div class="row  g-5">
    ...
    <!-- FEATURE AREA START -->
    <div class="rts-feature-area pt--120 pb-120">
        <div class="container">
            <div class="section-title-btn-area">
                <div class="section-title-area text-start">
                    <h3 class="section-title font-40" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Why Choose Hostie</h3>
                    <p class="desc" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">No matter which service you choose, you can expect the highest performance.</p>
                </div>
                <a href="#" class="title-btn rts-btn">Get Started</a>
            </div>
            <div class="section-inner">
                <div class="feature-wrapper">
                    <div class="row g-5 mt--60 inner-separator">
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--0 pt--50">
                            <div class="feature-wrapper text-center">
                                ...
                                <div class="content">
                                    ...
                                    <p class="desc">Share processes & data secure lona need to know basis</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--0 pt--50">
    ...
    <div class="rts-hosting-feature-area pt--120 pb-120">
        <div class="container">
            <div class="section-inner">
                <div class="row g-5">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="right-side-content">
                            <div class="section-title-area text-start">
                                <h3 class="section-title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Advanced Security
                                    Hosting Features</h3>
                                <p class="desc" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">We’ll move your first website to Cloud ways from any web host for without breaking your live site hosted on the old host..</p>
                            </div>
                            <ul class="feature-list">
                                <li class="one" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800"><i class="fa-solid fa-circle-check"></i>Get unlimited SSL security certificates</li>
                                <li class="two" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800"><i class="fa-solid fa-circle-check"></i>Protect your website from DDoS attacks</li>
                                <li class="three" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800"><i class="fa-solid fa-circle-check"></i>Secure your files with automatic backups</li>
                            </ul>
                            <a href="pricing.php" class="get-started-btn rts-btn" data-sal="slide-down" data-sal-delay="700" data-sal-duration="800">Get Started <i class="fa-light fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- TESTIMONIAL -->
    <section class="rts-testimonial area-3 section__padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="section-title-area w-500 text-center">
                    <h2 class="section-title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Our Client Feedback</h2>
                    <p class="desc" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">We’re honored and humbled by the great feedback we receive
                        from our customers on a daily basis.
                    </p>
                </div>
            </div>
            <!-- testimonial -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-inner">
                        <div class="rts-testimonial__slider testimonial__slider--three">
                            <div class="swiper-wrapper">
                                <!-- single testimonial -->
                                <div class="swiper-slide">
                        ...
                        <!-- pagination dot -->
                        <div class="swiper-pagination slider-center"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- BLOG START -->
    <section class="rts-blog-area pt--120 section-style-radius-blog">
        <div class="container">
            <div class="section-title-area text-center">
                <h3 class="section-title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Latest Articles</h3>
            ...
            <div class="section-inner" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                <div class="row">
                    <div class="col-lg-6 col-md-10 mb-5">
                        <div class="blog-wrapper align-items-center wrapper-z-index">
                            ...
                            <div class="content">
                                ...
                                <h3 class="blog-title"><a href="blog-details.php">Expanding Horizons: Announcing the
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="blog-wrapper align-items-center">
                            ...
                            <div class="content">
                                ...
                                <h3 class="blog-title"><a href="blog-details.php">Introducing Edge Page Caching, Argo
            ...
            <div class="container">
                <div class="row gy-40 justify-content-md-center">
                    <div class="col-lg-5 col-md-10">
                        <div class="rts-faq__first" data-sal="slide-right" data-sal-delay="500" data-sal-duration="800">
                    ...
                    <div class="col-lg-6 col-md-10 offset-lg-1">
                        <div class="rts-faq__accordion" data-sal="slide-left" data-sal-delay="600" data-sal-duration="800">
    ...
    <!-- CTA AREA -->
    <div class="rts-cta home-three">
        <div class="container">
            <div class="row">
                <div class="rts-cta__wrapper align-items-center">
                    <div class="rts-cta__left">
                        <h3 class="cta__title">Sign up for web
                            hosting today!</h3>
                    </div>
