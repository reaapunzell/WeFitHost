...
<!-- head area start -->
 ...
 <!-- head area end -->
<body class="template-game template-game-details">
    <!-- HEADER AREA START-->
        <?php include 'layout/header/header-five.php';?>
    <!-- HEADER AREA END -->

    <!-- game details -->
    <section class="rts-game-details pt--150 pb-120">
        <div class="container">
            <div class="row g-5 justify-content-center align-items-center">
                <div class="col-lg-4 col-md-5 col-sm-10">
                    <div class="game__details--img">
                        <img src="assets/images/game/collection/01.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-8 col-md-7 col-sm-10">
                    <div class="game__details--content">
                        <div class="game__details--content__cat">
                            <a href="#">Action</a>
                        </div>
                        <h2 class="game__details--content__title">Legacy of the Stars</h2>
                        <p class="game__details--content__details">
                            Legacy of the Stars" is an epic role-playing game set in a vast universe teeming with celestial wonders, ancient mysteries, and cosmic conflicts. Players take on the roles of intrepid spacefarers, exploring the far reaches of the galaxy, uncovering lost civilizations, and shaping the fate of entire star systems.
                        </p>
                        <div class="game__details--content__rating">
