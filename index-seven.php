...
<body class="template-game">

    <!-- HEADER AREA -->
        <?php include 'layout/header/header-five.php';?>
    <!-- HEADER AREA END -->
            ...
            <div class="row align-items-end position-relative">
                <div class="col-lg-7">
                    <div class="rts-hero__content w-750">
                        ...
                        <h1 class="heading" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Power Up with Our Premium Game Hosting Solutions <img src="assets/images/icon/game-4.svg" alt="">
                        </h1>

                        <div class="rts-hero-two__content--btn sal-animate" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                            <a href="pricing.php" class="rts-btn btn__long secondary__bg secondary__color">
                                get started

                            </a>
                            <a href="pricing-two.php" class="rts-btn btn__long border__white white__color">
                                Buy Now
                            </a>
                        </div>
                    ...
                    <div class="rts-hero__images position-relative">
                        <div class="rts-hero-main">
                            <div class="image-main ">
                                <img class="main top-bottom2" src="assets/images/banner/banner__seven__image.png" alt="">
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="rts-section text-center">
                    <div class="rts-section__two">
                        <h2 class="title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Popular Game Server</h2>
            ...
            <div class="row g-5">
                    ...
                    <div class="single__server">
                        <div class="single__server--content">
                            <div class="single__server--content__icon">
                                <img src="assets/images/icon/game-1.svg" width="73" height="73" alt="">
                            </div>
                            <h4 class="single__server--content__link">
                                <a href="#">GameServers.com</a>
                            </h4>
                            <p class="single__server--content__description">
                                Provides game server hosting for a wide range of games, with options for dedicated and shared servers.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single__server">
                        <div class="single__server--content">
                            <div class="single__server--content__icon">
                                <img src="assets/images/icon/game-2.svg" width="73" height="73" alt="">
                            </div>
                            <h4 class="single__server--content__link">
                                <a href="#">Game Server Hosting</a>
                            </h4>
                            <p class="single__server--content__description">
                                Provide dedicated or shared servers optimized for hosting specific games or game types.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single__server">
                        <div class="single__server--content">
                            <div class="single__server--content__icon">
                                <img src="assets/images/icon/game-3.svg" width="73" height="73" alt="">
                            </div>
                            <h4 class="single__server--content__link">
                                <a href="#">Dedicated Server Rental</a>
                            </h4>
                            <p class="single__server--content__description">
                                Offer dedicated servers exclusively for users' gaming needs, providing full control and customization options.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="game-banner">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="game__banner__content" style="background-image: url(assets/images/game/banner__bg.png);">
                        <div class="game__banner__content__box">
                            <div class="game__banner__content__box--purchase">
                                <span><img src="assets/images/icon/game.svg" alt=""></span>Purchase Game
                            </div>
                            ...
                            <p class="game__banner__content__box--description">
                                Welcome to a world where adventure awaits at every turn. Immerse yourself in epic battles, thrilling challenges, and boundless excitement as you embark on a journey like no other.
                            </p>
                            <div class="game__banner__content__box--button">
                                <a href="pricing.php" class="primary__btn ">Purchase Now</a>
                            </div>
                        </div>
                        <div class="game__banner__content__image">
                            <img src="assets/images/game/banner__image.png" alt="banner__image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-5">
                    <div class="rts-pricing-plan__tab">
                        ...
                        <div class="discount">
                            <span class="line">
                                <img src="assets/images/pricing/offer__vactor-2.svg" height="20" width="85" alt=""></span>
                            <p>20% save</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <svg width="40" height="39" viewBox="0 0 40 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_193_834" x1="19.9725" y1="-1.61164e-06" x2="19.9725" y2="39.0008" gradientUnits="userSpaceOnUse">
                                                <stop offset="10%" stop-color="#FBB231" />
    ...
    <div class="game-collection section__padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="rts-section text-center">
                        <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Our Game Collection</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="game__tab">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-action" aria-controls="nav-action">Action</button>
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-strategy" aria-controls="nav-strategy">Strategy</button>
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#puzzle" type="button" role="tab" aria-controls="puzzle" aria-selected="true">Puzzle</button>
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-horror" aria-controls="nav-horror">Horror</button>
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-multiplayer" aria-controls="nav-multiplayer">Multi Player</button>
                        </div>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="game__single">
                                <div class="game__single__box">
                                    ...
                                    <div class="game__single__box__meta">
                                        <h4 class="game__single__box__meta--title">
                                            <a href="game-details.php">Nebula Nexus</a>
                                        </h4>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="game__single">
                                <div class="game__single__box">
                                    ...
                                    <div class="game__single__box__meta">
                                        <h4 class="game__single__box__meta--title">
                                            <a href="game-details.php">Shadowrealm Saga</a>
                                        </h4>
                                        <div class="game__single__box__meta--pricing">
                                            <span class="old__pricing">
                                                $59.00
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="game__single">
                                <div class="game__single__box">
                                    ...
                                    <div class="game__single__box__meta">
                                        <h4 class="game__single__box__meta--title">
                                            <a href="game-details.php">Warzone Assault</a>
                                        </h4>
                                        <div class="game__single__box__meta--pricing">
                                            <span class="old__pricing">
                                                $59.00
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="game__single">
                                <div class="game__single__box">
                                    ...
                                    <div class="game__single__box__meta">
                                        <h4 class="game__single__box__meta--title">
                                            <a href="game-details.php">Eternal Odyssey</a>
                                        </h4>
                                        <div class="game__single__box__meta--pricing">
                                            <span class="old__pricing">
                                                $59.00
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="game__single">
                                <div class="game__single__box">
                                    ...
                                    <div class="game__single__box__meta">
                                        <h4 class="game__single__box__meta--title">
                                            <a href="game-details.php">Magic and Mystery</a>
                                        </h4>
                                        <div class="game__single__box__meta__flex">
                                            <div class="game__single__box__meta--pricing">
                                                <span class="current__pricing">$29.00</span>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="game__single">
                                <div class="game__single__box">
                                    ...
                                    <div class="game__single__box__meta">
                                        <h4 class="game__single__box__meta--title">
                                            <a href="game-details.php">Reign of Fire</a>
                                        </h4>
                                        <div class="game__single__box__meta__flex">
                                            <div class="game__single__box__meta--pricing">
                                                <span class="old__pricing">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="game__single">
                                <div class="game__single__box">
                                    ...
                                    <div class="game__single__box__meta">
                                        <h4 class="game__single__box__meta--title">
                                            <a href="game-details.php">Guardians of the Cosmos</a>
                                        </h4>
                                        <div class="game__single__box__meta--pricing">
                                            <span class="old__pricing">
                                                $59.00
    ...
    <!-- FOOTER AREA START-->
        <?php include 'layout/footer/footer-five.php';?>
    <!-- FOOTER AREA END -->
