...
<body class="page-template template-two">
    ...
    <section class="rts-hero-two rts-hero-two__bg">
            ...
            <div class="row justify-content-md-center">
                <div class="col-xl-6 col-lg-7 col-md-9 order-md-2 order-lg-0">
                    <div class="rts-hero-two__content">
                        ...
                        <div class="rts-hero-two__content--btn" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                            <a href="pricing.php" class="rts-btn btn__long secondary__bg secondary__color">get started
                                <i class="fa-regular fa-arrow-right"></i></a>
                            <a href="pricing-two.php" class="rts-btn btn__long border__white white__color">start free
                                <i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <div class="terms" data-aos="fade-down" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                            <img src="assets/images/banner/cloud--lightning.svg" alt="">
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-5 col-md-10">
                    <div class="rts-hero-two__images mobile-margin-top-100">
                        <img src="assets/images/banner/two/hero__two__illustration.svg" alt="">
                        <img class="shape-image one left-right-top-bottom" src="assets/images/banner/two/hero__two__illustration-sm1.svg" alt="">
                        <img class="shape-image two" src="assets/images/banner/two/hero__two__illustration-sm2.svg" alt="">
                        <img class="shape-image three" src="assets/images/banner/two/hero__two__illustration-sm3.svg" alt="">
                        <img class="shape-image four" src="assets/images/banner/two/hero__two__illustration-sm4.svg" alt="">
                        <img class="shape-image five" src="assets/images/banner/two/hero__two__illustration-sm5.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="shape">
            <div class="shape__one">
                <img src="assets/images/banner/banner__two__shape.svg" alt="">
            </div>
        </div>
    </section>
    <!-- HERO BANNER ONE END -->
    ...
    <!-- DOMAIN FINDER -->
    <div class="rts-ds-two cultured__white">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rts-ds-two__wrapper">
                        <form action="https://hostie-whmcs.themewant.com/cart.php" class="domain-search">
                            <input type="hidden" name="domain" value="register">
                            <input type="hidden" name="a" value="add">
                            <input type="text" placeholder="domain.com" name="query" required>
                            <button type="submit" name="domain_type" class="domain-btn rts-btn-secondary">Search
                                Domain</button>
                        </form>
                        <div class="rts-ds-two__domainlist">
                            <div class="single-list">
                                <div class="name">.com</div>
                                <span class="price">only $6.19</span>
                            </div>
                            <div class="single-list">
                ...
                <div class="col-lg-12">
                    <div class="rts-section section-style-two">
                        <div class="rts-section__two">
                            <h6 class="sub__title">Best Hosting</h6>
                            <h2 class="title" data-sal="slide-down" data-sal-delay="400" data-sal-duration="700">Best
                                Hosting Services</h2>
                            <p class="description mb-0" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">Select your solution and we will help you narrow down our best
                                high-speed options to fit your needs.</p>
                        </div>
                        <div class="rts-section-button">
                            <a href="pricing.php" class="rts-btn rts-btn-secondary">Learn More</a>
                        </div>
            ...
            <div class="row gy-30">
                <div class="col-lg-8 col-xl-6 col-md-8">
                    <div class="service-two">
                        <div class="service-two__content">
                            <h6 class="sub__title">Web Hosting</h6>
                            <h4 class="title">Web hosting involves renting
                                server from a hosting provider.
                            </h4>
                            <a href="cloud-hosting.php" class="primary__btn btn__two">Learn More</a>
                        </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <a href="vps-hosting.php" class="service-title">VPS Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="vps-hosting.php" class="service-btn"><i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- single service end -->
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <a href="dedicated-hosting.php" class="service-title">Dedicated Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="dedicated-hosting.php" class="service-btn"><i
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <a href="business-mail.php" class="service-title">Email Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="business-mail.php" class="service-btn"><i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <a href="wordpress-hosting.php" class="service-title">Eccommerce Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="wordpress-hosting.php" class="service-btn"><i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            ...
                            <a href="cloud-hosting.php" class="service-title">Cloud Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="cloud-hosting.php" class="service-btn"><i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            <div class="service-icon">
                                <img src="assets/images/service/two/cloud-2.svg" height="45" width="52" alt="">
                            </div>
                            <a href="reseller-hosting.php" class="service-title">Reseller Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="reseller-hosting.php" class="service-btn"><i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <!-- PRICING PLAN -->
    <div class="rts-pricing-plan pricing__section section__rounded pricing__bg section__padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="rts-section text-center">
                        <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Unleash Online Growth <br>
                            Not Budgets.</h2>
                        <p class="rts-section__description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">shared hosting is the easiest, most economical</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-5">
                    <div class="rts-pricing-plan__tab">
                        ...
                        <div class="discount">
                            <span class="line">
                                <img src="assets/images/pricing/offer__vactor.svg" height="20" width="85" alt=""></span>
                            <p>20% save</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="single-plan__content">
                                ...
                                <div class="plan-feature">
                                    <ul class="plan-feature__list">
                                        ...
                                        <li>
                                            <span><i class="fa-solid fa-check"></i> </span> Unlimited Application
                                            Installation
                                        </li>
                                        <li>
                            ...
                            <div class="single-plan__content">
                                ...
                                <div class="plan-feature">
                                    <ul class="plan-feature__list">
                                        ...
                                        <li>
                                            <span><i class="fa-solid fa-check"></i> </span> Optimized With Advanced
                                            Caches
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="row">
                <div class="rts-cta-two__wrapper">
                    ...
                    <div class="cta-content" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                        ...
                        <h4>Unleash Online Growth
                            Not Budgets.</h4>
                    </div>
                    <div class="cta-btn">
                        <a href="contact.php" class="contact__us rts-btn rts-btn-secondary">contact us</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center justify-content-sm-center">
                <div class="col-xl-6 col-lg-6 col-md-10 col-sm-10 order-2 order-lg-0">
                    <div class="rts-hosting-feature__content">
                        <div class="rts-section__two">
                            <h6 class="sub__title">Best Hosting</h6>
                            <h2 class="title" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">Have
                                Complete Peace
                                of Mind with Migration</h2>
                            <p class="description" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                                We’ll move your first website to Cloud ways from any web host for without breaking your
                                live site hosted.</p>
                        </div>
                            ...
                            <ul>
                                <li data-sal="slide-up" data-sal-delay="800" data-sal-duration="800">
                                    <div class="hosting-feature__single feature__one">
                                        ...
                                        <p class="feature-text">Maximize website loading speed</p>
                                    </div>
                                </li>
                                <li data-sal="slide-left" data-sal-delay="900" data-sal-duration="800">
                                    <div class="hosting-feature__single feature__two">
                                        ...
                                        <p class="feature-text">Enjoy optimized performance</p>
                                    </div>
                                </li>
                                <li data-sal="slide-down" data-sal-delay="1000" data-sal-duration="800">
                                    <div class="hosting-feature__single feature__three">
                                        ...
                                        <p class="feature-text">Reduce website response times</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
    ...
    <section class="rts-testimonial-two testimonial__bg section__padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="rts-section section-style-two">
                        <div class="rts-section__two">
                            <h6 class="sub__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                                Testimonials</h6>
                            <h2 class="title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                                Featured Client Stories</h2>
                            <p class="description mb-0" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">We’re honored and humbled by the great feedback we receive
                                from our customers on a daily basis.
                            </p>
                        </div>
                        <div class="rts-section-button rts-slider__btn__two ">
                            <div class="slide__btn rts-prev"><i class="fa-regular fa-chevron-left"></i></div>
                            <div class="slide__btn rts-next"><i class="fa-regular fa-chevron-right"></i></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="testimonial-slider-two mb--60">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="rts-testimonial-two__single">
                                    <div class="quote"><img src="assets/images/icon/quote__white.svg" alt=""></div>
                                    <div class="testimonial-text">
                                        <h5>We are grateful to have found an ideal managed
                                            cloud hosting platform for our customers, and look
                                            to grow our hosting business through Cloudways.
                                        </h5>
                                    </div>
                                    <div class="rating">
                        ...
                        <div class="rts-swiper-scrollbar"></div>
                    </div>
    ...
    <!-- FEATURED CLIENT TESTIMONIAL END -->

    <!-- HOSTING FEATURE TWO -->
    <section class="rts-hosting-feature-two cultured__white section__padding">
        <div class="container">
            <div class="row g-40 justify-content-sm-center">
                <div class="col-lg-6 col-md-10 col-sm-10">
                    <div class="rts-hosting-feature-two__image">
                        <img src="assets/images/hosting/hosting__feature__two.png" alt="">
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-1 col-md-10 col-sm-10">
                    <div class="rts-hosting-feature-two__content">
                        <div class="rts-section__two">
                            <h6 class="sub__title">feature</h6>
                            <h3 class="title font-40" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Advanced Security
                                Features</h3>
                        ...
                        <a href="pricing.php" class="rts-btn rts-btn-secondary">get started</a>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!-- HOSTING FEATURE TWO END -->

    <!-- HOSTING LATEST BLOG -->
    <section class="rts-blog section__rounded round__section bg-white section__padding">
        <div class="container">
            <div class="row justify-content-center justify-content-md-start">
                <div class="col-md-12 col-sm-10">
                    <div class="rts-section section-style-two">
                        <div class="rts-section__two">
                            <h6 class="sub__title">our blog</h6>
                            <h2 class="title mb-0" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                                Latest Blog</h2>
                        </div>
                        <div class="rts-section-description">
                            <p class="description w-560" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                                We’ll move your first website to Cloud ways from any web host for without breaking your
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cta__button">
                        <p>Looking for a Hosting solution?</p><a href="contact.php" class="light__cta">Contac Us</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="rts-brand__wrapper">
                        <div class="rts-brand__wrapper--text">
                            <h3 class="animated fadeIn">Hosting solutions trusted by the owners of
