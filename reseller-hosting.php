        ...
        <div class="container">
            <div class="row">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content resell__banner">
                        <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Reseller Hosting</span>
                        <h1 class="banner-title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                            Flexible Reseller
                            Hosting
                        </h1>
                        <p class="slogan" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Resell Web Hosting to Earn Revenue &
                            Support Your Clients</p>
                        <div class="hosting-action" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                            <a href="pricing.php" class="btn__two secondary__bg secondary__color">View Plan <i class="fa-regular fa-arrow-right"></i></a>
                            <a href="#" class="btn__white">Starting @ $10.00/mo</a>
                        </div>
                    </div>
                    <div class="rts-hosting-banner__image reseller-banner__image">
                        <img src="assets/images/banner/banner__resell__image.svg" alt="">
                        <img class="shape-image one" src="assets/images/banner/banner__resell__image-sm1.svg" alt="">
                        <img class="shape-image two" src="assets/images/banner/banner__resell__image-sm2.svg" alt="">
                        <img class="shape-image three pulsing" src="assets/images/banner/banner__resell__image-sm3.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section  text-center">
                    ...
                    <p class="rts-section__description w-450" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Globally incubate next-generation e-services via state of the art technology.
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row g-30">
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                    <div class="cloud-feature">
                        ...
                        <h4 class="title">Easy Hosting Management</h4>
                        <p class="description">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="assets/images/feature/cloud/billing.svg" height="50" width="60" alt="">
                        </div>
                        <h4 class="title">Automated Billing Software</h4>
                        <p class="description">
                            If your site has outgrown the shared hosting
                            solutions it’s time to move to the cloud.
                        </p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="assets/images/feature/cloud/moneybag.svg" height="50" width="60" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="assets/images/feature/cloud/speed-meter.svg" height="50" width="60" alt="">
                        </div>
                        <h4 class="title">LiteSpeed Web</h4>
                        <p class="description">
                            If your site has outgrown the shared hosting
                            solutions it’s time to move to the cloud.
                        </p>
        ...
        <div class="container">
            <div class="row">
                <div class="rts-section text-center">
                    ...
                    <p class="rts-section__description w-450" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">We’re honored and humbled by the great feedback we receive from our customers on a daily basis.
                    </p>
                </div>
            </div>
            <!-- client feedback -->
