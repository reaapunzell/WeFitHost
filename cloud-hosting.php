...
<body class="page-template template-cloud">
        ...
        <div class="container">
            <div class="row justify-content-sm-center">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content cloud__banner">
                        <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Cloud Hosting</span>
            ...
            <div class="row g-30">
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        ...
                        <p class="description">
                            Get a Dedicated IP for better security, stability, and performance. Ideal for businesses, eCommerce, and high-traffic sites.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        ...
                        <p class="description">
                            SSL Included for secure, encrypted connections. Protect your website, boost trust, and improve SEO effortlessly.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                    <div class="cloud-feature">
                        ...
                        <p class="description">
                            White-label Reselling lets you brand and sell hosting as your own. Perfect for agencies and entrepreneurs.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                    <div class="cloud-feature">
                        ...
                        <p class="description">
                            Daily Backups keep your data safe with automatic restores. Protect your site from loss or unexpected issues.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                    <div class="cloud-feature">
                        ...
                        <p class="description">
                            Collaboration Tools streamline teamwork with easy access, role management, and real-time updates.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- SUPPORT FEATURE -->
    <div class="rts-support-feature section__padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-7">
                    <div class="support-feature__content">
                        <h2 class="title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Advanced Priority
                            Support
                        </h2>
                        <p class="description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                            Cloud issues reported on chat or ticket are assigned with priority to our most experienced support agents available.
                        </p>
                        <div class="priority-content" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                            <div class="single-priority">
                                ...
                                <div class="content">
                                    ...
                                    <p class="mb-0">By our best agents</p>
                                </div>
                            </div>
                            <div class="single-priority">
                                <div class="icon">
